  ...
  return (
    ...
    <Root>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to RojgarApp, the software
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to RojgarApp.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          <p>
            ...
            <a
              ...
              data-cfemail="65160215170a0f0006115357250208040c094b060a08"
            >
              [email&nbsp;protected]
            </a>
          </p>
        ...
        <li>
          <p>
            ...
            <a
              href="https://www.rojgarapp.in/privacy-policy/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.rojgarapp.in/privacy-policy/
            </a>
          </p>
        </li>
      </ul>
